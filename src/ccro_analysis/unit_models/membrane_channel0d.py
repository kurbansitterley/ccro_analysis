...
class MembraneChannel0DBlockData(MembraneChannelMixin, ControlVolume0DBlockData):
    ...
    def initialize(
        ...
        init_log.info_high(
            f"MembraneChannel0D Initialization, BEFORE get_state_args. DOF = {degrees_of_freedom(self.parent_block())}"
        )
        ...
        init_log.info_high(
            f"MembraneChannel0D Initialization, AFTER get_state_args. DOF = {degrees_of_freedom(self.parent_block())}"
        )
        ...
        init_log.info_high(
            f"MembraneChannel0D Initialization, AFTER properties_in initialize. DOF = {degrees_of_freedom(self.parent_block())}"
        )
        ...
        init_log.info_high(
            f"MembraneChannel0D Initialization, AFTER properties_out initialize. DOF = {degrees_of_freedom(self.parent_block())}"
        )
        ...
        init_log.info_high(
            f"MembraneChannel0D Initialization, AFTER properties_interface initialize. DOF = {degrees_of_freedom(self.parent_block())}"
        )
